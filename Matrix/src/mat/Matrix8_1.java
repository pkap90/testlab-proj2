...
// Add Wrong Matrix Dimensions Error Handling in Determinant functionality
public class Matrix8_1 {

    public double[][] Value;
    public int rows, columns;

    public Matrix8_1(int rows, int columns, double[] array) {
        this.rows = rows;
    ...
    private Matrix8_1(int dimension) {
        this.rows = dimension;
    ...
    public static Matrix8_1 Identity(int dimension) {
        return new Matrix8_1(dimension);
    }

    public static Matrix8_1 AddMatrices(Matrix8_1 m1, Matrix8_1 m2) {
        if (m1.rows != m2.rows || m1.columns != m2.columns) {
            throw new RuntimeException("Sizes of given Matrices don't match.");
        }

        Matrix8_1 result = new Matrix8_1(m1.rows, m1.columns, new double[]{});
    ...
    public static Matrix8_1 MultiplyMatrixByScalar(Matrix8_1 m, double scalar) {
        ...
        return new Matrix8_1(m.rows, m.columns, array);
    }
    ...
    public static double Determinant(Matrix8_1 matrix) {
